 ...
 const [navOpen, setNavOpen] = useContext(NavbarContext)
  ...
  return (
    <div className="flex fixed  top-0 w-full items-start justify-between z-4">
      <Link to='/'>
      <div className="lg:w-36 w-24 p-3">
        <svg
          className=" w-full"
      ...
      >
        <div className="bg-black  h-full flex flex-col gap-1  px-5  items-end justify-center md:w-full">
          <div
            className={`h-[2px] w-7 md:w-14 ${
              isHover ? "bg-gray-700 " : "bg-white"
            } z-30`}
          ></div>
          <div
            className={`h-[2px] w-4 md:w-7 ${
              isHover ? "bg-gray-700" : "bg-white"
            } z-30`}
          ></div>
        </div>
